...
#MISE wait_for=[":build:currencies"]
...
# because `better-auth generate` loads src/auth.ts
# which depends on PrismaClient generated by `prisma generate`
prisma generate

auth generate --adapter prisma --yes --output="./prisma/models/better-auth.prisma" # relative path from config root
